      ...
      <div class="grid-cols-3 md:col-span-3 space-y-6">
        <div class="bg-gray-600 p-4 rounded-2xl shadow ">
          ...
          <textarea class="w-full border rounded-lg p-2 mb-3 focus:outline-none focus:ring-2 focus:ring-green-500" rows="3" placeholder="O que está rolando?"></textarea>
            ...
            <div class="flex flex-wrap gap-2 mb-3">
              <button class="bg-pink-100 text-pink-600 px-4 py-2 rounded-lg hover:bg-pink-700">Jogo passando</button>
              <button class="bg-pink-100 text-blue-600 px-4 py-2 rounded-lg hover:bg-pink-700">Quero companhia</button>
              <button class="bg-pink-100 text-green-600 px-4 py-2 rounded-lg hover:bg-pink-700">Promoção</button>
              <button class="bg-pink-100 text-yellow-600 px-4 py-2 rounded-lg hover:bg-pink-700">Highlights</button>
            </div>
            <div>
